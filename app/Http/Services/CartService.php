...
class CartService{
    ...
    public function add($product, $qty)
    {
        ...
        else
        {
            ...
            Session::put("cart.product_{$product->id}.size", $product->size);
            Session::put("cart.product_{$product->id}.metal", $product->metal);
            Session::put("cart.product_{$product->id}.stone", $product->stone);
            Session::put("cart.product_{$product->id}.availability", $product->availability);
            Session::put("cart.product_{$product->id}.recommended", $product->recommended);
